...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate vday = LocalDate.of(2022, 02, 14);
    ...
    public static void testEarlyRetirement() {
        // TODO
        LocalDate bday = LocalDate.of(1999, 9 ,30);
    ...
    public static void testElectionDay() {
        // TODO
        LocalDate election = LocalDate.of(2024, 11, 1);
        LocalDate adjustedDay = election.with(TemporalAdjusters.firstInMonth(DayOfWeek.MONDAY)).plusDays(1);
        System.out.println(adjustedDay.getDayOfWeek());
    }
    ...
    public static void testAnniversary() {
        // TODO
        LocalDate marriage = LocalDate.of(2024, 4, 17);
